...
function lr() {
  if (Te) return I;
  Te = 1;
  var D = Se, _ = Symbol.for("react.element"), S = Symbol.for("react.fragment"), y = Object.prototype.hasOwnProperty, P = D.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, C = { key: !0, ref: !0, __self: !0, __source: !0 };
  function h(R, f, w) {
    var p, g = {}, m = null, W = null;
    w !== void 0 && (m = "" + w), f.key !== void 0 && (m = "" + f.key), f.ref !== void 0 && (W = f.ref);
    for (p in f) y.call(f, p) && !C.hasOwnProperty(p) && (g[p] = f[p]);
    if (R && R.defaultProps) for (p in f = R.defaultProps, f) g[p] === void 0 && (g[p] = f[p]);
    return { $$typeof: _, type: R, key: m, ref: W, props: g, _owner: P.current };
  }
...
function fr() {
  return Oe || (Oe = 1, process.env.NODE_ENV !== "production" && function() {
    var D = Se, _ = Symbol.for("react.element"), S = Symbol.for("react.portal"), y = Symbol.for("react.fragment"), P = Symbol.for("react.strict_mode"), C = Symbol.for("react.profiler"), h = Symbol.for("react.provider"), R = Symbol.for("react.context"), f = Symbol.for("react.forward_ref"), w = Symbol.for("react.suspense"), p = Symbol.for("react.suspense_list"), g = Symbol.for("react.memo"), m = Symbol.for("react.lazy"), W = Symbol.for("react.offscreen"), H = Symbol.iterator, Pe = "@@iterator";
    function Ce(e) {
    ...
    function Ae(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === y || e === C || Fe || e === P || e === w || e === p || De || e === W || je || xe || ke || typeof e == "object" && e !== null && (e.$$typeof === m || e.$$typeof === g || e.$$typeof === h || e.$$typeof === R || e.$$typeof === f || // This needs to include all possible module reference object
...
` + a[s].replace(" at new ", " at ");
    ...
    var q = j.ReactCurrentOwner, ge = j.ReactDebugCurrentFrame;
    function x(e) {
      if (e) {
        var r = e._owner, t = V(e.type, e._source, r ? r.type : null);
    ...
    function _e(e, r) {
      {
        ...
        Ee[t] = !0;
        var n = "";
        e && e._owner && e._owner !== q.current && (n = " It was passed a child from " + E(e._owner.type) + "."), x(e), c('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', t, n), x(null);
      }
    }
    function he(e, r) {
      {
    ...
    function me(e, r, t, n, i, u) {
      {
        ...
        if (A.call(r, "key")) {
          var O = E(e), v = Object.keys(r).filter(function(sr) {
            return sr !== "key";
...
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, z, O, ur, O), Re[O + z] = !0;
          }
        }
...
function dr({
  ...
  const h = [
    ...
    `ds-button--${D}`,
    `ds-button--${_}`,
    S ? "ds-button--disabled" : ""
  ].filter(Boolean).join(" ");
  return /* @__PURE__ */ cr.jsx("button", { className: h, disabled: S, onClick: y, ...C, children: P });
}
const pr = { Button: dr };
export {
  dr as Button,
